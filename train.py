...
# ======================
# Save Model + Vectorizer (BOTH .pkl and .joblib)
# ======================
...
# Save in .joblib format (for compatibility with other scripts)
joblib.dump(model, "models/logreg_model.joblib")
joblib.dump(vectorizer, "models/tfidf_vectorizer.joblib")

print("💾 Model + vectorizer saved in BOTH .pkl and .joblib formats!")
